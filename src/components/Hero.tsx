        ...
        <div className="relative md:w-3/5">
          <div className="align-middle px-8 pt-8 md:pt-0">
            ...
            <div className="md:flex mt-10">
              ...
              <button type="button" className="flex text-white bg-cyan-500 hover:bg-cyan-800 font-medium rounded-full text-sm px-3 py-4 md:px-5 md:py-4 text-center mb-2 transition duration-700 ease-in-out w-full md:w-fit justify-center">
