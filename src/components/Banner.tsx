  ...
  return (
    <div className="grid grid-col-1 md:grid-cols-5 bg-amber-50 text-amber-900 items-center overflow-hidden rounded-xl">
      <div className="col-span-1 md:col-span-3 py-4 px-10 md:p-10">
        <h3 className="text-2xl md:text-3xl mb-2 font-bold">#TomasContraDuchenne</h3>
        <p className="text-base mb-4">Necesito tu ayuda para costear el medicamento más caro del mundo. Puedes colaborarme haciendo una donación o difundiendo en las redes sociales.</p>
        <p className="font-semibold mb-2">Juntos podemos logralo.</p>
        <div className="flex justify-start items-center gap-6 w-full md:w-fit mt-0 md:mt-4 md:mt-0">
          <Link
            href="/donar"
