    ...
    <div id="mi-historia" className="px-8 md:py-24 md:px-36 md:h-screen bg-indigo-100 text-indigo-800">
      <div className="rounded-3xl md:flex h-full">
        <div className="align-middle px-18 pt-16">
          ...
          <p className="text-xl md:text-3xl my-8">Conoce mi testimonio completo <span className="font-bold underline decoration-pink-500 underline-offset-8 cursor-pointer">aquí</span>.</p>
          <div className="flex mt-4">
            ...
            <button type="button" className="flex text-white bg-indigo-400 hover:bg-indigo-600 focus:outline-none font-medium rounded-full text-sm px-3 py-4 md:px-5 md:py-4  text-center me-2 mb-2 transition duration-700 ease-in-out">
