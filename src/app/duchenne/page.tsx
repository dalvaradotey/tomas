...
export default function Duchenne() {
  return (
    <>
      <div className="p-8 md:py-24 md:px-36 text-lg leading-9 space-y-4">
        <h1 className="text-3xl font-semibold">Distrofia Muscular de Duchenne (DMD)</h1>
        ...
        <h2 className="text-2xl font-semibold">Etapas</h2>
        <h3 className="text-xl font-semibold">Edad Temprana (desde el diagnóstico hasta los 7)</h3>
        ...
        <h3 className="text-xl font-semibold">Etapa de Transición (edades de 6 a 9)</h3>
        ...
        <h3 className="text-xl font-semibold">Pérdida de Capacidad para Caminar (edades de 10 a 14)</h3>
        ...
        <h3 className="text-xl font-semibold">Etapa Joven adulto (edades 15+)</h3>
        ...
        <p className="text-sm text-gray-600">Fuente: <a href="https://www.duchenne-spain.org/que-es-duchenne" className="text-blue-500 underline" target="_blank">https://www.duchenne-spain.org/que-es-duchenne</a></p>
        <h3 className="text-xl font-semibold">Tratamiento que necesita Tomás, Elevidys</h3>
        ...
        <p className="text-sm text-gray-600">Fuente: <a href="https://www.duchenne-spain.org/blog/sarepta-therapeutics-anuncia-la-aprobacion-por-parte-de-la-fda-de-elevidys-la-primera-terapia-genica-para-tratar-la-distrofia-muscular-de-duchenne" className="text-blue-500 underline" target="_blank">https://www.duchenne-spain.org/blog/sarepta-therapeutics-anuncia-la-aprobacion-por-parte-de-la-fda-de-elevidys-la-primera-terapia-genica-para-tratar-la-distrofia-muscular-de-duchenne/</a></p>
      </div>
      <div className="mt-10">
        <Banner />
      </div>
