  ...
  return (
    <>
      ...
      <div className="p-8 md:py-36 md:px-40 space-y-10">
        <h1 className="text-5xl font-semibold">Distrofia Muscular de Duchenne (DMD)</h1>
        ...
        <h2 className="text-4xl font-semibold">Etapas</h2>
        <h3 className="text-3xl font-extralight">Edad Temprana (desde el diagnóstico hasta los 7)</h3>
        ...
        <h3 className="text-3xl font-extralight">Etapa de Transición (edades de 6 a 9)</h3>
        ...
        <h3 className="text-3xl font-extralight">Pérdida de Capacidad para Caminar (edades de 10 a 14)</h3>
        ...
        <h3 className="text-3xl font-extralight">Etapa Joven adulto (edades 15+)</h3>
        ...
        <h3 className="text-3xl font-extralight">Tratamiento que necesita Tomás, Elevidys</h3>
