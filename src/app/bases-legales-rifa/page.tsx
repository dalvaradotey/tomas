  ...
  return (
    <>
      <div className="p-8 md:py-24 md:px-36 text-lg leading-9 space-y-4">
        <h1 className="text-3xl font-semibold mb-8">Bases Concurso &ldquo;Gana una Parcela en Chiloé&rdquo;</h1>
        <div className="grid gap-12">
          <div>
            <h2 className="text-2xl font-semibold mb-6">Primero: Individualización del creador y organizador del Concurso</h2>
          ...
          <div>
            <h2 className="text-2xl font-semibold mb-6">Segundo: Requisitos para participar y publicaciones de las bases.</h2>
            <p>Sin perjuicio de las condiciones del concurso que se indicarán más abajo. Las bases también se detallarán en la página web <a href="https://www.tomascontraduchenne.com" className="text-blue-500 underline">www.tomascontraduchenne.com</a> y podrán participar todas aquellas personas naturales, Chilenas o extranjeras que adquieran uno o más tickets en los términos expresados en las siguientes bases del concurso.</p>
          </div>
          <div>
            <h2 className="text-2xl font-semibold mb-6">Tercero: Objetivo del concurso </h2>
          ...
          <div>
            <h2 className="text-2xl font-semibold mb-6">Cuarto: Vigencia del concurso y detalles de Bases</h2>
